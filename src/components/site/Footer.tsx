      ...
      <div className="relative mx-auto max-w-7xl px-4 grid md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-white shadow-lg flex items-center justify-center">
              <img src={logo} alt="Hassan Medical Store logo" className="h-8 w-auto object-contain" />
            </div>
          ...
          <p className="mt-6 text-brand-light/60 text-base max-w-sm leading-relaxed">
            Pakistan's premium digital pharmacy. Experience the gold standard 
            of healthcare with genuine medicines and 24/7 expert care.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-medium">
            <li><a href="#features" className="text-brand-light/60 hover:text-brand-green transition-colors">Features</a></li>
            <li><a href="#products" className="text-brand-light/60 hover:text-brand-green transition-colors">Products</a></li>
            <li><a href="#assistant" className="text-brand-light/60 hover:text-brand-green transition-colors">AI Assistant</a></li>
            <li><a href="#upload" className="text-brand-light/60 hover:text-brand-green transition-colors">Upload Rx</a></li>
          </ul>
        </div>
        <div>
