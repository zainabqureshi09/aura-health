...
const features = [
  { icon: Pill, title: "Online Pharmacy", desc: "Browse thousands of authentic medicines and order in seconds." },
  { icon: FileUp, title: "Prescription Upload", desc: "Securely upload your Rx and let our expert pharmacists handle the rest." },
  { icon: Truck, title: "Swift Delivery", desc: "Same-day temperature-controlled delivery across all major cities." },
  { icon: Headphones, title: "Expert Support", desc: "Direct access to licensed pharmacists for all your healthcare queries." },
  { icon: ShieldCheck, title: "Genuine Quality", desc: "100% authentic medical supplies sourced directly from manufacturers." },
  { icon: Zap, title: "Express Service", desc: "Urgent medical needs dispatched within minutes of confirmation." },
];
    ...
    <section id="features" className="relative py-32 bg-white/30">
      <div className="mx-auto max-w-7xl px-4">
        <div className="max-w-3xl mb-16">
          ...
          >
            We combine pharmaceutical expertise with modern technology to deliver 
            a healthcare experience that's fast, reliable, and patient-centered.
          </motion.p>
        </div>
          ...
          {features.map((f, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="mt-4 text-brand-muted leading-relaxed text-base">
                  {f.desc}
                </p>
